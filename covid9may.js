(function() {
    ...
    myConnector.getData = function(table, doneCallback) {
        $.getJSON("https://api.covid19india.org/raw_data.json", function(res) {
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            tableau.connectionName = "COVID Feed till 9 May"; // This will be the data source name in Tableau
